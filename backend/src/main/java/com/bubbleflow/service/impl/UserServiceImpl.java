...
import com.bubbleflow.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse create(UserCreateRequest request) {
        ...
        if (request.getRoleIds() != null && !request.getRoleIds().isEmpty()) {
            ...
            if (!isAdmin) {
                throw new com.bubbleflow.exception.BusinessException("Chỉ Quản trị viên mới có quyền gán vai trò khi tạo người dùng.");
            }
        }
    ...
    public UserResponse update(Long id, UserUpdateRequest request) {
        ...
        if (isChangeRolesAttempt) {
            ...
            boolean isAdmin = auth != null && auth.getAuthorities().stream()
                    .anyMatch(a -> a.getAuthority().equals("ROLE_ADMIN") || a.getAuthority().equals("ROLE_TYPE_ALL"));
            if (!isAdmin) {
                throw new com.bubbleflow.exception.BusinessException("Chỉ Quản trị viên mới có quyền thay đổi vai trò của người dùng.");
            }
        }
