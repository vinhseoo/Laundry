...
CREATE INDEX IF NOT EXISTS idx_laundry_baskets_order_id ON laundry_baskets (order_id);
CREATE INDEX IF NOT EXISTS idx_laundry_baskets_equipment_id ON laundry_baskets (equipment_id);
